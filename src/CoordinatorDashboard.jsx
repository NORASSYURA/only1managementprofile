...
import { Award, AlertTriangle, BellRing, Building, CheckSquare, ChevronRight, ExternalLink, FileText, HardHat, Phone, Printer, Search, Send, Share2, Square, Users, X, DollarSign, Camera } from 'lucide-react';
...
export default function CoordinatorDashboard() {
  ...
  const [reliefSchedules, setReliefSchedules] = useState([
    { id: 'REL-01', category: 'Permanent', project: 'P103 Punggol Nightshift', primaryOperator: 'Tan Kok Kheong', leaveTotal: '4 Days Leave', status: 'Action Required', schedule: [ { date: '4/9', reliever: 'Asyurl Relieve', status: 'Assigned' }, { date: '9/9', reliever: '⚠️ Unassigned (Need Reliever)', status: 'Open' } ] },
    { id: 'REL-02', category: 'Permanent', project: 'Cc09b Dayshift', primaryOperator: 'Muhammad Asyrul', leaveTotal: '4 Days Leave', status: 'Fully Covered', schedule: [ { date: '4/9', reliever: 'Faisal Kader Relieve', status: 'Assigned' }, { date: '5/9', reliever: 'Faisal Kader Relieve', status: 'Assigned' } ] },
    { id: 'REL-09', category: 'Planning', project: 'Woodland Extension ICA Immigration (Dayshift)', primaryOperator: 'Muhammad Razif (Naga)', leaveTotal: '5 Days Leave', status: 'Fully Covered', machine: 'XCMG / S.E Crane (Hirose)', schedule: [ { date: '6/9', reliever: 'Dan Mustaqim Relieve', status: 'Assigned' }, { date: '7/9', reliever: 'Dan Mustaqim Relieve', status: 'Assigned' } ] }
  ]);
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans">
      ...
      <footer className="bg-neutral-950 border-t border-neutral-800/80 py-4 px-4 text-center text-xs text-neutral-500">
        <p className="font-mono"> THE ONLY1PROFILEMANAGEMENT • UEN: 53530731D • Singapore </p>
        <p className="text-[11px] text-neutral-600 mt-0.5"> Farhan Aziz • Google Developer • Luxe Living & Builder • Jin Shun Foundation • South East Battery </p>
      </footer>
    </div>
  );
}
