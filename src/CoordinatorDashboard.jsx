              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl space-y-3">
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg text-xs space-y-1">
                    <div className="text-neutral-400 text-[11px]">Formula calculation:</div>
                    <div className="text-amber-300 font-mono font-bold text-sm"> {timesheetForm.dailyHours} Hours × S$ {currentOperator.rate} × {timesheetForm.totalDays} Day(s) = S$ {claimSummary.basePay.toFixed(2)} </div>
                    <div className="text-emerald-400 font-bold font-mono text-sm pt-1 border-t border-amber-500/20 flex justify-between"> <span>Total Transferred:</span> <span>S$ {claimSummary.total.toFixed(2)}</span> </div>
                  </div>
                </div>
              </div>
